...
# --- 설정 ---
# 생성할 파일의 총 개수
TOTAL_FILES_TO_CREATE = 10

# 원본이 되는 파일 이름
SOURCE_FILENAME = "evaluate_HD_1.py"

# 원본 파일에서 찾아 바꿀 코드 라인
LINE_TO_FIND = 'parameter_data = "data/data_1.xlsx"'
# --- 설정 끝 ---
...
def create_files():
    ...
    for i in range(21, TOTAL_FILES_TO_CREATE + 1):
        # 새로운 파일 이름과 데이터 경로를 만듭니다.
        new_filename = f"evaluate_HD_{i}.py"
        new_data_path_line = f'parameter_data = "data/data_{i}.xlsx"'
