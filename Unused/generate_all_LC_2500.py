...
# --- 설정 ---
# 생성할 파일의 총 개수
TOTAL_FILES_TO_CREATE = 30

# 원본이 되는 파일 이름
SOURCE_FILENAME = "Final_Best_Code.py"

# 원본 파일에서 찾아 바꿀 첫 번째 import 라인
LINE_TO_FIND_1 = "from evaluate_HD_1 import evaluate"

# 원본 파일에서 찾아 바꿀 두 번째 import 라인
LINE_TO_FIND_2 = "from constraint_utils_numpy_1 import load_s_table, adjust_chromosome"
# --- 설정 끝 ---
...
def create_files():
    ...
    for i in range(1, TOTAL_FILES_TO_CREATE + 1):
        ...
        new_filename = f"Main_{i}.py"
        new_import_line_1 = f"from evaluate_HD_{i} import evaluate"
